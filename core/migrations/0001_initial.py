# Generated by Django 2.0.6 on 2018-10-22 12:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('std_no', models.CharField(default=None, max_length=7, validators=[django.core.validators.RegexValidator(regex='^\\d{7}$')])),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('father', models.CharField(default=None, max_length=255)),
                ('phone_number', models.CharField(default=None, max_length=10, validators=[django.core.validators.RegexValidator(regex='^[789]\\d{9}$')])),
                ('branch', models.CharField(default=None, max_length=5)),
                ('skills', models.CharField(default=None, max_length=255)),
                ('designer', models.CharField(default=None, max_length=255)),
                ('hosteler', models.CharField(default=None, max_length=3)),
