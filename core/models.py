...
class Candidate(models.Model):
    ...
    university_roll_no = models.CharField(max_length=10, blank=False, unique=True, null=True)
    ...
    phone_number = models.CharField(validators=[phone_regex], max_length=10, blank=False, null=True)
