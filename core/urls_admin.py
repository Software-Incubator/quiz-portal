...
urlpatterns = [
    ...
    path('deleteinstruction/<str:key>', views_admin.DeleteInstructionView.as_view(), name='Delete_Instruction'),
    ...
    path('showquestions/(?P<pk>\d+)', views_admin.ShowQuestionsView.as_view(), name='Show_Questions'),
