...
urlpatterns = [
    ...
    path('home/', views_candidate.SelectTest.as_view(), name="home"),
    path('<test_name>/instruction/', views_candidate.InstructionView.as_view(), name='instruction'),
    path('logout/', views_candidate.logout, name='session_out'),
    path('<test_name>/category/<category_name>/<int:id>', views_candidate.QuestionByCategory.as_view(), name='category'),
    ...
    path('end/', views_candidate.EndPage.as_view(), name='ending'),
